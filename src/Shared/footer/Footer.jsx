...
//     <Link to={"/skill"} className="link link-hover">Skills</Link>
//   </nav> 
//   <nav>
...
// </footer>
//         </div>
<footer className="footer footer-center p-10 bg-[#0c1829] text-white rounded-lg">
      {/* Navigation Links */}
      <nav className="flex flex-wrap justify-center gap-6 text-base">
        <Link to="/" className="hover:text-[#c5a7a4] transition duration-300">Home</Link>
        <Link to="/about" className="hover:text-[#c5a7a4] transition duration-300">About</Link>
        <Link to="/contact" className="hover:text-[#c5a7a4] transition duration-300">Contact</Link>
        <Link to="/project" className="hover:text-[#c5a7a4] transition duration-300">Projects</Link>
        <Link to="/skill" className="hover:text-[#c5a7a4] transition duration-300">Skills</Link>
      </nav>

      {/* Social Icons */}
      <div className="flex flex-wrap justify-center gap-6 mt-4">
        <a
          href="https://www.linkedin.com/in/tanjina-sultana-2658092a3"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform duration-300"
        >
          <Linkedin size={24} className="text-white hover:text-[#c5a7a4]" />
        </a>
        <a
          href="https://github.com/TanjinaSultana"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform duration-300"
        >
          <Github size={24} className="text-white hover:text-[#c5a7a4]" />
        </a>
        <a
          href="mailto:tanjinasultana388@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform duration-300"
        >
          <Mail size={24} className="text-white hover:text-[#c5a7a4]" />
        </a>
        <a
          href="tel:+8801641715275"
          className="flex items-center gap-2 hover:text-[#c5a7a4] transition duration-300"
        >
          <Phone size={20} className="text-white" />
          <span className="text-sm sm:text-base">+8801641715275</span>
        </a>
      </div>

      {/* Footer Note */}
      <aside className="mt-4 text-sm text-gray-300">
        <p>© 2023 - All rights reserved by <span className="text-[#c5a7a4] font-semibold">Tanjina Sultana</span></p>
      </aside>
    </footer>
