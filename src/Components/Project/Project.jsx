...
<div className='bg-[#0c1829]'>
  ...
  {/* Tour And Guide */}
  <div className="hero min-h-screen bg-[#0c1829]">
    <div className="hero-content flex flex-col lg:flex-row items-center gap-6 lg:gap-16 px-4 md:px-12">
      <img src={image2} className="w-40 sm:w-64 md:w-80 lg:w-[500px] rounded-lg shadow-2xl" />
      <div className="flex-1 text-center lg:text-left">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#FFFFFF]">Tour And Guide</h1>
        <p className="py-6 text-sm sm:text-base md:text-lg text-[#FFFFFF]">
          Tour-And-Guide is an Ecommerce Website.Where user,admin and tour-guide dashboard feature added and also integrated payment system with stripe method.
        </p>
        <button className="btn bg-[#c5a7a4] text-[#0c1829]" onClick={()=>document.getElementById('my_modal_1').showModal()}>Explore More</button>

        <dialog id="my_modal_1" className="modal">
          <div className="modal-box max-w-full sm:max-w-lg">
            <form method="dialog">
              <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
            </form>
            <h3 className="font-bold text-lg">Tour And Guide E-commerce Platform [5days]</h3>
            <h2 className='font-bold mt-2'>Description:</h2>
            <p>● Engineered responsive and visually engaging user interfaces with React.js, Material-UI, HTML5, and CSS3, resulting in a seamless browsing experience for tourists and guides.</p>
            <p>● Developed distinct dashboards for administrators, tour guides, and tourists, enhancing user engagement and accessibility.</p>
            <p>● Integrated a secure payment process, leveraging industry-standard encryption techniques for seamless and trustworthy transactions.</p>
            <p className='font-medium mt-2'>Technologies Used:React.js, Material-UI, JavaScript, HTML, Material UI, Express.js, MongoDB</p>
            <div className='flex justify-center mt-4'>
              <a href="https://tour-guide-b6f45.web.app" className="btn btn-outline bg-[#c5a7a4] text-[#0c1829]">Live Link</a>
            </div>
          </div>
        </dialog>
      </div>
  ...
  {/* Local Tour Guide */}
  <div className="hero min-h-screen bg-[#0c1829] mt-16">
    <div className="hero-content flex flex-col lg:flex-row-reverse items-center gap-6 lg:gap-16 px-4 md:px-12">
      <img src={image3} className="w-40 sm:w-64 md:w-80 lg:w-[500px] rounded-lg shadow-2xl" />
      <div className="flex-1 text-center lg:text-left">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#FFFFFF]">Local Tour Guide</h1>
        <p className="py-6 text-sm sm:text-base md:text-lg text-[#FFFFFF]">
          Local Tour is a tour service based website.In this website user can book tour according their Choice.Dasboard feature are added where can manage and add tours
        </p>
        <button className="btn bg-[#c5a7a4] text-[#0c1829]" onClick={()=>document.getElementById('my_modal_7').showModal()}>Explore More</button>
        ...
        <dialog id="my_modal_7" className="modal">
          <div className="modal-box max-w-full sm:max-w-lg">
            ...
            <h3 className="font-bold text-lg">Local Tour And Guide Ecommerce [4days]</h3>
            <h2 className='font-bold mt-2'>Description:</h2>
            <p>● Optimized website performance through efficient database queries and responsive design principles.</p>
            <p>● Engineered and deployed a robust service booking system for a local tour and guide e-commerce website, leveraging cutting-edge technologies.</p>
            <p>● Implemented an intuitive dashboard with Express.js and MongoDB for tour operators to efficiently manage and showcase their services.</p>
            <p className='font-medium mt-2'>Technology Used:React.js, JavaScript (JS), Mamba UI, HTML, CSS3, Express.js, MongoDB</p>
            <div className='flex justify-center mt-4'>
              <a href="https://service-client-side.web.app" className="btn btn-outline bg-[#c5a7a4] text-[#0c1829]">Live Link</a>
            </div>
          </div>
        </dialog>
      </div>
  ...
  <div className="hero min-h-screen bg-[#0c1829] mt-16">
    <div className="hero-content flex flex-col lg:flex-row items-center gap-6 lg:gap-16 px-4 md:px-12">
      <img src={image1} className="w-40 sm:w-64 md:w-80 lg:w-[500px] rounded-lg shadow-2xl" />
      <div className="flex-1 text-center lg:text-left">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#FFFFFF]">ReMerce</h1>
        <p className="py-6 text-sm sm:text-base md:text-lg text-[#FFFFFF]">
          BrandShop is a website based on with some popular branded.Add to cart feature are added and user can update and delete the product.Authentication are added.
        </p>
        <button className="btn bg-[#c5a7a4] text-[#0c1829]" onClick={()=>document.getElementById('my_modal_9').showModal()}>Explore More</button>
        ...
        <dialog id="my_modal_9" className="modal">
          <div className="modal-box max-w-full sm:max-w-lg">
            ...
            <h3 className="font-bold text-lg">ReMerce E-commerce Website [2days]</h3>
            <h2 className='font-bold mt-2'>Description:</h2>
            <p>● Engineered a seamless and dynamic "Add to Cart" feature using React.js, JavaScript, and Daisy UI to enhance the user shopping experience.</p>
            <p>● Implemented an intuitive interface allowing users to effortlessly add products to their cart, providing a frictionless ecommerce journey.</p>
            <p>● Utilized Express.js and MongoDB to securely store and retrieve cart data, optimizing for efficiency.</p>
            <p className='font-medium mt-2'>Technology Used:React.js, JavaScript (JS), Daisy UI, HTML, CSS3, Express.js & MongoDB</p>
            <div className='flex justify-center mt-4'>
              <a href="https://brandshop-client-side-43a1b.web.app" className="btn btn-outline bg-[#c5a7a4] text-[#0c1829]">Live Link</a>
            </div>
          </div>
        </dialog>
      </div>
